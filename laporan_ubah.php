    ...
    <div class="col-md-12">
      <form method="post">
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($koneksi, "UPDATE peminjam SET id_buku_FK='$id_buku', id_user='$id_user',tanggal_peminjaman='$tanggal_peminjaman',tanggal_pengembalian= '$tanggal_pengembalian',  terlambat_hari='$terlambat_hari',total_denda='$total_denda',status_peminjaman='$status_peminjaman' WHERE id_peminjaman=$id");
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                while($buku= mysqli_fetch_array($buk)) {
                    ?>
                    <option <?php if($buku['id_buku'] == $data['id_buku_FK']) echo 'selected'; ?> value="<?php echo $buku['id_buku'];?>"><?php echo $buku['judul'];?></option>
                    <?php
