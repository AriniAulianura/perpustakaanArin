<h1 class="mt-4">PEMINJAMAN UBAH</h1>
<div class="card">
    <div class="card-body">
    <div class="row">
    <div class="col-md-12">
      <form method="post">
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($koneksi, "UPDATE peminjam SET id_buku_Fk='$id_buku',Kd_peminjam= '$Kd_peminjam', id_user='$id_user',tanggal_peminjaman='$tanggal_peminjaman',tanggal_pengembalian= '$tanggal_pengembalian',  terlambat_hari='$terlambat_hari',total_denda='$total_denda',jumlah= '$jumlah',status_peminjaman='$status_peminjaman' WHERE id_peminjaman=$id");
