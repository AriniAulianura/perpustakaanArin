    ...
    <div class="col-md-12">
      <form method="post">
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($koneksi, "INSERT INTO buku VALUES ('','$id_kategori','$judul','$Foto','$penulis','$penerbit','$tahun_terbit','$Stok','$deskripsi')");
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                <?php
                $kate = mysqli_query($koneksi, "SELECT * FROM kategori");
